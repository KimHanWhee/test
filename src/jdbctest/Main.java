...
//				System.out.println(u.getUserId());
			...
			// head(10개만 보여주기 for loop 도 나쁘지않음 )
			...
			// elseif 2번이면
				...
				boolean flag2 = true;
				while (flag2) {
					System.out.println("1.평점순으로 정렬 2. 특정 배우 작품 찾기 3. 특정 감독의 작품 찾기 4.특정 장르 검색  9. 메인화면 ");
					userChoice = sc.nextInt();
					// 공통적으로 나가기 만들것.!!!!
					if (userChoice == 1) {
						// select * from drama order by desc 평점
						System.out.println("나가시려면 9를 눌러주세요  ");
						userChoice = sc.nextInt();
						if (userChoice == 9)
							continue;
						...
						String str = sc.next();
						System.out.println(top10.SearchActor(str));
						// select * from drama where 배우 like "%아이유%"
						System.out.println("나가시려면 9를 눌러주세요  ");
						userChoice = sc.nextInt();
						if (userChoice == 9)
							continue;
						...
						String str = sc.next();
						System.out.println(top10.SearchDirector(str));
